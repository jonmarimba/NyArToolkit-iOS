...
namespace NyARToolkitCPP
{
	...
	class NyARLabeling_ARToolKit:public INyARLabeling
	{
	public:
	...
	private:
		...
		INyARLabelingImage* _out_image;
	public:
		void attachDestination(INyARLabelingImage* i_destination_image);
		const INyARLabelingImage* getAttachedDestination()const;
		void labeling(const NyARBinRaster& i_raster);
	};
}
