...
{	
	NyARGrayscaleRaster::NyARGrayscaleRaster(int i_width, int i_height):NyARRaster_BasicClass(i_width,i_height)
	{		
	...
	NyARGrayscaleRaster::~NyARGrayscaleRaster()
	{
	 ...
	 const INyARBufferReader* NyARGrayscaleRaster::getBufferReader()const
	{
